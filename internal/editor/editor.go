...
func (e *Editor) InsertLineBelow() {
	...
	// 2. Insert newline at the end of the current line
	e.Buffer.InsertNewline(row, lineLen)

	// 3. Position cursor at the beginning of the newly created line below
	e.Cursor.SetPos(0, row+1)
